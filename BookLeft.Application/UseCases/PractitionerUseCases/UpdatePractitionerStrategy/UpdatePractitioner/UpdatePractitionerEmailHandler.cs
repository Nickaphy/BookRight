...
{
    public class UpdatePractitionerEmailHandler : PractitionerUpdateStrategyBase
    {
        public UpdatePractitionerEmailHandler(IPractitionerRepository practitionerRepository) : base(practitionerRepository)
        {
        }
        ...
        public override async Task UpdateAsync(Practitioner entity, object command)
        {
            ...
            var updateCommand = command as UpdatePractitionerEmailCommand;
            ...
            entity.UpdateEmail(updateCommand.Email);
